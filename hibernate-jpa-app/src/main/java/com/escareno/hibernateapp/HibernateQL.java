...
import com.escareno.hibernateapp.dominio.ClienteDTO;
...
public class HibernateQL {
    public static void main(String[] args) {
        ...
        List<ClienteDTO> clientesDto = em.createQuery("select new com.escareno.hibernateapp.dominio.ClienteDTO(c.nombre, c.apellido) from Cliente c", ClienteDTO.class)
                .getResultList();
...
//                .getResultList();
        // ignorar ese error o poner el query de arriba con concat
