...
<body class="container">
    ...
    <form action="/webapp-form/registro" method="POST">
        ...
        <div class="row mb-3">
            <label class="col-form-label col-sm-2" for="lenguajes">Lenguaje de programación</label>
            <div class="col-sm-4">
                <select class="form-select" name="lenguajes" id="lenguajes" multiple>
        ...
        <div class="row mb-3">
            ...
            <div class="form-check col-sm-2">
                <input type="radio" name="idioma" value="es" class="form-check-input" ${param.idioma.equals("es") ? "selected" : ""}>
                <label class="form-check-label">Español</label>
            </div>

            <div class="form-check col-sm-2">
                <input type="radio" name="idioma" value="en" class="form-check-input" ${param.idioma.equals("en") ? "selected" : ""}>
                <label class="form-check-label">Inglés</label>
            </div>

            <div class="form-check col-sm-2">
                <input type="radio" name="idioma" value="fr" class="form-check-input" ${param.idioma.equals("fr") ? "selected" : ""}>
                <label class="form-check-label">Fránces</label>
            </div>
